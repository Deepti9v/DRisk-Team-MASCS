...
switch(complexityLevel){
	case 1:
         ...
         */
        var Neighbours = {
        	Alaska: ['Greenland', 'Quebec', 'WesternUnitedStates'],
        	Greenland: ['Alaska', 'Quebec', 'Iceland'],
        	Quebec: ['Greenland', 'Alaska', 'WesternUnitedStates'],
        	WesternUnitedStates: ['Alaska', 'Quebec'],
        	Brazil: ['Argentina', 'NorthAfrica'],
        	Argentina: ['Brazil'],
        	NorthAfrica: ['Egypt', 'Brazil', 'SouthernEurope', 'SouthAfrica'],
        	Egypt: ['NorthAfrica', 'MiddleEast', 'SouthernEurope', 'SouthAfrica', 'Madagascar'],
        	SouthAfrica: ['NorthAfrica', 'Egypt', 'Madagascar'],
        	Iceland: ['Greenland', 'Ukraine', 'GreatBritain'],
        	GreatBritain: ['Iceland', 'Ukraine', 'SouthernEurope'],
        	SouthernEurope: ['GreatBritain', 'Ukraine', 'MiddleEast', 'Egypt', 'NorthAfrica'],
        	Madagascar: ['SouthAfrica', 'Egypt'],
        	Ukraine: ['SouthernEurope', 'Iceland', 'GreatBritain', 'MiddleEast', 'India', 'Siberia'],
        	MiddleEast: ['SouthernEurope', 'India', 'Ukraine', 'Egypt'],
        	India: ['MiddleEast','Afghanistan','China','Siam'],
        	China: ['China', 'MiddleEast', 'Indonesia'],
        	Siberia: ['Ukraine', 'China', 'Japan'],
        	Japan: ['China', 'Siberia'],
        	Indonesia: ['India', 'NewGuinea', 'WesternAustralia'],
        	NewGuinea: ['India', 'Indonesia', 'WesternAustralia'],
        	WesternAustralia: ['NewGuinea', 'Indonesia'],
        };
	...
	case 2:
        ...
        var Neighbours = {
        	...
        	NorthWestTerritory: ['Alaska', 'Alberta', 'Greenland'],
        	Alberta: ['EasternUnitedStates', 'Quebec', 'Greenland'],
        	Greenland: ['NorthWestTerritory', 'Alberta', 'Quebec', 'Iceland'],
        	Quebec: ['EasternUnitedStates', 'Greenland', 'Alberta'],
        	EasternUnitedStates: ['CentralAmerica', 'Alberta', 'Quebec'],
        	CentralAmerica: ['EasternUnitedStates', 'Brazil'],
        	Brazil: ['CentralAmerica', 'Argentina', 'NorthAfrica'],
        	Argentina: ['Brazil'],
        	NorthAfrica: ['WesternEurope', 'NorthernEurope', 'Egypt', 'EastAfrica'],
        	Egypt: ['NorthernEurope', 'EastAfrica', 'MiddleEast'],
        	EastAfrica: ['Madagascar', 'SouthAfrica', 'NorthAfrica', 'MiddleEast'],
        	SouthAfrica: ['EastAfrica', 'Madagascar'],
        	Iceland: ['Greenland', 'GreatBritain', 'Ukraine'],
        	GreatBritain: ['Iceland', 'Ukraine', 'NorthernEurope', 'WesternEurope'],
        	WesternEurope: ['NorthernEurope', 'GreatBritain', 'NorthAfrica'],
        	NorthernEurope: ['WesternEurope', 'Ukraine', 'GreatBritain', 'MiddleEast', 'Egypt', 'NorthAfrica'],
        	Madagascar: ['EastAfrica', 'SouthAfrica'],
        	Ukraine: ['NorthernEurope', 'Siberia', 'Afghanistan', 'MiddleEast'],
        	MiddleEast: ['NorthernEurope', 'Egypt', 'EastAfrica', 'Ukraine', 'India', 'Afghanistan'],
        	Afghanistan: ['Ukraine', 'Siberia', 'China', 'India', 'MiddleEast'],
        	India: ['MiddleEast', 'Afghanistan', 'China', 'Siam'],
        	Siam: ['India', 'China', 'Indonesia'],
        	China: ['Afghanistan', 'Siberia', 'Mongolia', 'Siam', 'India'],
        	Mongolia: ['China', 'Siberia', 'Yakutsk', 'Japan'],
        	Yakutsk: ['Siberia', 'Mongolia', 'Japan'],
        	Siberia: ['Ukraine', 'Afghanistan', 'Yakutsk', 'Mongolia', 'China'],
        	Japan: ['Mongolia', 'Yakutsk'],
        	Indonesia: ['Siam', 'EasternAustralia', 'NewGuinea'],
        	NewGuinea: ['Indonesia', 'EasternAustralia'],
        	EasternAustralia: ['NewGuinea', 'Indonesia'],
        }
	...
	case 3:
        ...
        var Neighbours = {
        	...
        	CentralAmerica: ['Western UnitedStates','EasternUnitedStates','Venezuela'],
        	...
        	NewGuinea: ['Indonesia','Western Australia','EasternAustralia'],
